...
public class GlobalExceptionController {
	...
	public final ModelAndView handleException(Exception ex, WebRequest request) {
	 ...
	 * @param request the current request
	 */
	protected ModelAndView handleExceptionInternal(Exception ex, Object body,
	 ...
	 * @since 4.0
	 */
	protected ModelAndView handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
	                                                     HttpStatus status, WebRequest request) {
